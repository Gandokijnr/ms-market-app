...
// Function to get the route for the subitem
const getSubItemRoute = (category, subcategory) => {
  const routeMap = {
    // Define the route mappings for each subitem
    iphone: 'iphonechecklist',
    samsung: 'samsungchecklist',
    infinix: 'infinixchecklist',
    tekno: 'teknochecklist',
    itel: 'itelchecklist',
    others: 'otherschecklist',
  };
  const routeName = routeMap[subcategory] || 'defaultview';
  return { name: routeName, params: { category, subcategory } };
};
</script>
